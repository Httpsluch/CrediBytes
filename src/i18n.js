...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      "ui.panelOn": "Side panel enabled — the toolbar icon now opens the panel.",
      "ui.panelOff": "Side panel disabled — the toolbar icon opens the popup again.",
      "ui.reportBugUnset": "No bug form is configured yet.",
      "ui.reportBugCopied": "Your version and settings were copied — paste them into the form.",
      ...
      "action.verified": "Registration confirmed. Always review the loan terms before applying. For more information about lending-company registration, contact the SEC at (02) 8818-0921 or sec.gov.ph/contact-us.",
      "action.short.verified": "Review the loan terms before applying.",
      "action.possible": "Verify the platform before applying or sharing personal information. You may confirm its registration with the SEC at (02) 8818-0921.",
      "action.short.possible": "Verify the platform before sharing information.",
      "action.notFound": "Avoid sharing personal information. To confirm whether this lending platform is recorded, contact the SEC at (02) 8818-0921 or use the official contact page at https://www.sec.gov.ph/contact-us/, where you can find the appropriate email channel.",
      "action.short.notFound": "Avoid sharing personal information.",
      "action.flagged": "Avoid sharing personal or financial information with this platform. You may report or confirm the lender with the SEC at (02) 8818-0921.",
      "action.short.flagged": "Do not share personal or financial information.",
      "action.revoked": "Do not proceed. This company's authority to lend has been withdrawn. Confirm the latest status with the SEC at (02) 8818-0921.",
      "action.short.revoked": "Do not proceed.",
      "btn.checkListing": "Check this app's listing",
      "btn.checking": "Checking…",
      "btn.failed": "We could not read this app listing. Try again later.",
      "btn.failed.permission": "Store access was not allowed. Allow access and try again if you want to check this listing.",
      "btn.failed.unavailable": "This app is not available in the Philippine store or may have been removed.",
      "btn.failed.blocked": "The store blocked the request for now. Try again later.",
      "btn.failed.generic": "We could not read this app listing. Check your connection and try again later.",
      ...
      "ds.note": "This is what the developer declared to the {store}. It does not by itself mean that the lender did something wrong.",
    },
    ...
    tl: {
      ...
      "ui.panelOn": "Naka-on ang side panel — ang toolbar icon ay magbubukas na ng panel.",
      "ui.panelOff": "Naka-off ang side panel — popup na ulit ang bubukas sa toolbar icon.",
      "ui.reportBugUnset": "Wala pang naka-set na bug form.",
      "ui.reportBugCopied": "Nakopya ang bersyon at settings mo — i-paste ito sa form.",
      ...
      "action.verified": "Kumpirmado ang rehistrasyon. Suriin pa rin ang mga tuntunin ng pautang bago mag-apply. Para sa dagdag na impormasyon tungkol sa rehistrasyon ng lending company, makipag-ugnayan sa SEC sa (02) 8818-0921 o sec.gov.ph/contact-us.",
      "action.short.verified": "Suriin ang mga tuntunin ng pautang bago mag-apply.",
      "action.possible": "I-verify ang platform bago mag-apply o magbahagi ng personal na impormasyon. Maaari mong kumpirmahin ang rehistrasyon nito sa SEC sa (02) 8818-0921.",
      "action.short.possible": "I-verify ang platform bago magbahagi ng impormasyon.",
      "action.notFound": "Iwasang magbahagi ng personal na impormasyon. Para makumpirma kung nakatala ang lending platform na ito, makipag-ugnayan sa SEC sa (02) 8818-0921 o gamitin ang opisyal na contact page sa https://www.sec.gov.ph/contact-us/, kung saan makikita ang tamang email channel.",
      "action.short.notFound": "Iwasang magbahagi ng personal na impormasyon.",
      "action.flagged": "Iwasang magbahagi ng personal o pinansyal na impormasyon sa platform na ito. Maaari mong i-report o kumpirmahin ang lender sa SEC sa (02) 8818-0921.",
      "action.short.flagged": "Huwag magbahagi ng personal o pinansyal na impormasyon.",
      "action.revoked": "Huwag magpatuloy. Binawi na ang awtoridad ng kompanyang ito na magpautang. Kumpirmahin ang pinakabagong status sa SEC sa (02) 8818-0921.",
      "action.short.revoked": "Huwag magpatuloy.",
      "btn.checkListing": "Suriin ang listing ng app na ito",
      "btn.checking": "Sinusuri…",
      "btn.failed": "Hindi mabasa ang listing ng app na ito. Subukan muli mamaya.",
      "btn.failed.permission": "Hindi pinayagan ang access sa store. Payagan ang access at subukan muli kung gusto mong suriin ang listing.",
      "btn.failed.unavailable": "Hindi available ang app sa Philippine store o maaaring inalis na ito.",
      "btn.failed.blocked": "Pansamantalang hinarang ng store ang request. Subukan muli mamaya.",
      "btn.failed.generic": "Hindi mabasa ang listing ng app na ito. Suriin ang internet at subukan muli mamaya.",
      ...
      "ds.note": "Ito ang idineklara mismo ng gumawa ng app sa {store}. Hindi nito awtomatikong ibig sabihin na may ginawang mali ang lender.",
    },
  };
