...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      "ui.sidePanelDesc": "Badges on ads plus Chrome's side panel",
      "ui.refNote": "SEC reference: Philippines OLA Registry",
      "ui.openSidePanel": "Open in side panel",
      "ui.scans": "{n} scans",
      ...
      "check.pkgNotStore": "Not an app store link",
    ...
    tl: {
      ...
      "ui.sidePanelDesc": "Mga badge sa ad kasama ang side panel ng Chrome",
      "ui.refNote": "Sanggunian ng SEC: Philippines OLA Registry",
      "ui.openSidePanel": "Buksan sa side panel",
      "ui.scans": "{n} na scan",
      ...
      "check.pkgNotStore": "Hindi ito app store link",
